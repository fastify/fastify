...
- [`fastify-tokenize`](https://github.com/Bowser65/fastify-tokenize) [Tokenize](https://github.com/Bowser65/Tokenize) plugin for Fastify that leverages the pain of managing authentication tokens, with built-in integration for `fastify-auth`
