...
- [`fastify-apollo-step`](https://github.com/codejie/fastify-apollo-step) Set up [Apollo Server](https://github.com/apollographql/apollo-server)(2.0.x) with Fastify. Supports graphiql/playground module.
