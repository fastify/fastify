...
- [`k-fastify-gateway`](https://github.com/jkyberneees/fastify-gateway) API Gateway plugin implementation for `fastify`, a low footprint plugin implementation that uses the `fastify-reply-from` HTTP proxy library.
