...
+ [Migrating from Express](./Migration-From-Express.md): Maps common Express
  patterns to their Fastify equivalents, with code examples for routing,
  middleware, error handling, validation, and incremental migration.
