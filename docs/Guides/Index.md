...
+ [Migration Guide (v5)](./Migration-Guide-V5.md): Details how to migrate to
  Fastify v5 from earlier versions.
+ [Migration Guide (v6)](./Migration-Guide-V6.md): Details how to migrate to
  Fastify v6 from earlier versions.
