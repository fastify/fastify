...
+ [Migrating from Express](./Migration-Guide-Express.md): Maps common Express
  patterns to Fastify equivalents with side-by-side code examples for teams
  moving an existing Express application to Fastify.
