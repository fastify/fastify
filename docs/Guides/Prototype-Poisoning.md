...
While this story is focused on a specific framework however, any solution that uses `JSON.parse()` to process external data is potentially at risk.
...
It is prototype-based object-oriented language.
