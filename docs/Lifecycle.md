...
- the [reply serialized](./Referenence/Server.md#setreplyserializer) if set
- or by the [serializer compiler](./Referenence/Server.md#setserializercompiler) when a JSON schema has been set for the returning HTTP status code
