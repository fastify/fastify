...
- [Errors](#errors)
  ...
  - [Fastify Error Codes](#fastify-error-codes)
    ...
    - [FST_ERR_ROUTE_INVALID_LOG_LEVEL_OPTION](#fst_err_route_invalid_log_level_option)
...
| <a id="fst_err_route_invalid_log_level_option">FST_ERR_ROUTE_INVALID_LOG_LEVEL_OPTION</a> | `logLevel` option must be a valid log level. | Use a valid log level: `trace`, `debug`, `info`, `warn`, `error`, `fatal`, or `silent`. | - |
