...
- [Errors](#errors)
  ...
  - [Fastify Error Codes](#fastify-error-codes)
    ...
    - [FST_ERR_DEC_INVALID_BOUND_OPTION](#fst_err_dec_invalid_bound_option)
...
| <a id="fst_err_dec_invalid_bound_option">FST_ERR_DEC_INVALID_BOUND_OPTION</a> | The `boundToFastify` option was used on a decorator that is not a function. | Only use `boundToFastify` when accessing function decorators. | [#](https://github.com/fastify/fastify/pull/)
