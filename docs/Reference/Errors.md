...
| <a id="fst_err_log_invalid_log_dispatcher">FST_ERR_LOG_INVALID_LOG_DISPATCHER</a> | The `logDispatcher` option must be an instance of `LogDispatcher`. | Extend the `LogDispatcher` class and pass an instance. | - |
