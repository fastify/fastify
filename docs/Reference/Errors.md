...
| <a id="fst_err_route_log_level_invalid">FST_ERR_ROUTE_LOG_LEVEL_INVALID</a> | `logLevel` or `requestLogLevel` must match a configured logger level. | Use one of the configured logger levels for the route option. | [#6523](https://github.com/fastify/fastify/pull/6523) |
