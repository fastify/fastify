...
| <a id="fst_err_route_log_level_invalid">FST_ERR_ROUTE_LOG_LEVEL_INVALID</a> | Route-level `logLevel` value is invalid. | Use one of the supported logger levels for route `logLevel`. | [#6609](https://github.com/fastify/fastify/pull/6609) |
