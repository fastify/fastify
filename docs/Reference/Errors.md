...
| <a id="fst_err_log_invalid_logger_level">FST_ERR_LOG_INVALID_LOGGER_LEVEL</a> | Must be one of trace, debug, info, warn, warn, error, fatal.  | [#6129](https://github.com/fastify/fastify/pull/6129) |
