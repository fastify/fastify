...
| <a id="fst_err_route_log_level_invalid">FST_ERR_ROUTE_LOG_LEVEL_INVALID</a> | `logLevel` option must be one of [trace, debug, info, warn, error, fatal]. | Use a valid log level. | - |
