...
Beware that calling again `reply.send(error)` in your custom error handler will end sending the error to the default error handler.
Check out the [Reply Lifecycle](./Reference/Lifecycle#reply-lifecycle), for more information.
