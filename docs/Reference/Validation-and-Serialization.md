...
```js
{
  ...
  removeAdditional: true, // remove additional properties if additinalProperties is set to false, see also: https://ajv.js.org/guide/modifying-data.html#removing-additional-properties
