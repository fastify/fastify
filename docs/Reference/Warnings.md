...
| <a id="FSTDEP022">FSTDEP022</a> | You are using the deprecated json shorthand schema. Specify full object schema instead. It will be removed in `fastify@v5`. | [#5483](https://github.com/fastify/fastify/pull/0000) |
