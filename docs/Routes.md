...
* `validatorCompiler(method, url, httpPart, schema)`: the function that build the schema for the validations. See [here](https://github.com/fastify/fastify/blob/master/docs/Validation-and-Serialization.md#schema-validator)
* `serializerCompiler(method, url, httpPart, schema)`: the function that build the schema for the serialization. See [here](https://github.com/fastify/fastify/blob/master/docs/Validation-and-Serialization.md#schema-serializer)
