...
* `errorHandler(error, request, reply)`: a custom error handler for the scope of this request. For this route, overrides the default error global handler, and anything set by [`setErrorHandler`](./Server.md#setErrorHandler)
