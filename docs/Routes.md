...
* `preDecoding(request, reply, payload, done)`: a [function](https://github.com/fastify/fastify/blob/master/docs/Hooks.md#predecoding) called before reading the request payload, it could also be an array of functions.
