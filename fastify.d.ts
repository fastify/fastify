...
declare function fastify<
  Generic extends FastifyInstanceHttp2SecureGenericInterface
>(options: FastifyHttp2SecureOptions<Generic>): FastifyInstance<Generic> & PromiseLike<FastifyInstance<Generic>>
declare function fastify<
  Generic extends FastifyInstanceHttp2GenericInterface
>(options: FastifyHttp2Options<Generic>): FastifyInstance<Generic> & PromiseLike<FastifyInstance<Generic>>
declare function fastify<
  Generic extends FastifyInstanceHttpsGenericInterface
>(options: FastifyHttpsOptions<Generic>): FastifyInstance<Generic> & PromiseLike<FastifyInstance<Generic>>
declare function fastify<
  Generic extends FastifyInstanceHttpGenericInterface
>(options?: FastifyServerOptions<Generic>): FastifyInstance<Generic> & PromiseLike<FastifyInstance<Generic>>
