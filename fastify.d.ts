...
declare namespace fastify {
  ...
  export type {
    ...
    FastifyLoggerOptions, FastifyBaseLogger, FastifyChildLoggerFactory, FastifyLoggerInstance, FastifyLogFn,
    ...
    FastifySchema, FastifySchemaValidationError, FastifySchemaCompiler, FastifySerializerCompiler,
    SchemaErrorDataVar, SchemaErrorFormatter, // './types/schema'
    ...
    ConnectionError, FastifyHttp2Options, FastifyHttp2SecureOptions, FastifyHttpOptions, FastifyHttpsOptions,
