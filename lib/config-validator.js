...
if(data.strictContentTypeHeaderValidation === undefined){
data.strictContentTypeHeaderValidation = true;
}
...
if(valid0){
let data9 = data.strictContentTypeHeaderValidation;
...
validate10.errors = [{instancePath:instancePath+"/strictContentTypeHeaderValidation",schemaPath:"#/properties/strictContentTypeHeaderValidation/type",keyword:"type",params:{type: "boolean"},message:"must be boolean"}];
return false;
}
}
if(coerced10 !== undefined){
data9 = coerced10;
if(data !== undefined){
data["strictContentTypeHeaderValidation"] = coerced10;
}
}
}
...
let missing0;
if((data11.allowHTTP1 === undefined) && (missing0 = "allowHTTP1")){
const err6 = {};
if(vErrors === null){
vErrors = [err6];
}
...
if(_errs41 === errors){
if(data11.allowHTTP1 !== undefined){
let data12 = data11.allowHTTP1;
...
if(valid0){
let data13 = data.ignoreTrailingSlash;
...
data13 = coerced15;
if(data !== undefined){
data["ignoreTrailingSlash"] = coerced15;
}
}
}
var valid0 = _errs45 === errors;
if(valid0){
let data14 = data.ignoreDuplicateSlashes;
...
data14 = coerced16;
if(data !== undefined){
data["ignoreDuplicateSlashes"] = coerced16;
}
}
}
...
module.exports.defaultInitOptions = {"connectionTimeout":0,"keepAliveTimeout":72000,"maxRequestsPerSocket":0,"requestTimeout":0,"handlerTimeout":0,"bodyLimit":1048576,"caseSensitive":true,"allowUnsafeRegex":false,"strictContentTypeHeaderValidation":true,"disableRequestLogging":false,"ignoreTrailingSlash":false,"ignoreDuplicateSlashes":false,"maxParamLength":100,"onProtoPoisoning":"error","onConstructorPoisoning":"error","pluginTimeout":10000,"requestIdHeader":false,"requestIdLogLabel":"reqId","http2SessionTimeout":72000,"exposeHeadRoutes":true,"useSemicolonDelimiter":false,"allowErrorHandlerOverride":true,"routerOptions":{"ignoreTrailingSlash":false,"ignoreDuplicateSlashes":false,"maxParamLength":100,"allowUnsafeRegex":false,"useSemicolonDelimiter":false}}
/* c8 ignore stop */
