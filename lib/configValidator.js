...
var validate = (function() {
  ...
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (data.maxRequestsPerSocket === undefined) data.maxRequestsPerSocket = null;
...
module.exports.defaultInitOptions = {"connectionTimeout":0,"keepAliveTimeout":5000,"maxRequestsPerSocket":null,"bodyLimit":1048576,"caseSensitive":true,"disableRequestLogging":false,"jsonShorthand":true,"ignoreTrailingSlash":false,"maxParamLength":100,"onProtoPoisoning":"error","onConstructorPoisoning":"error","pluginTimeout":10000,"requestIdHeader":"request-id","requestIdLogLabel":"reqId","http2SessionTimeout":5000}
