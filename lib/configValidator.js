                                      ...
                                      if (valid0) {
                                        ...
                                        if (valid0) {
                                          ...
                                          if (!(((typeof data18 === 'number') && (!(data18 % 1) && !isNaN(data18))) && (isFinite(data18)))) {
                                            const dataType20 = typeof data18
                                            let coerced20
                                            ...
                                            if (valid0) {
                                              ...
                                              if (valid0) {
                                                ...
                                                if (!(((typeof data21 === 'number') && (!(data21 % 1) && !isNaN(data21))) && (isFinite(data21)))) {
                                                  const dataType24 = typeof data21
                                                  let coerced24
                                                    ...
                                                    if (valid0) {
                                                      ...
                                                      if (valid0) {
                                                        if (data.constraints !== undefined) {
                                                          const data25 = data.constraints
                                                          const _errs74 = errors
                                                          if (errors === _errs74) {
                                                            if (data25 && typeof data25 === 'object' && !Array.isArray(data25)) {
                                                              for (const key2 in data25) {
                                                                const data26 = data25[key2]
                                                                    ...
                                                                    if (((((data26.name === undefined) && (missing2 = 'name')) || ((data26.storage === undefined) && (missing2 = 'storage'))) || ((data26.validate === undefined) && (missing2 = 'validate'))) || ((data26.deriveConstraint === undefined) && (missing2 = 'deriveConstraint'))) {
                                                                      ...
                                                                      if (data26.name !== undefined) {
                                                                        ...
                                                                        if (typeof data27 !== 'string') {
                                                                          const dataType27 = typeof data27
                                                                          let coerced27
