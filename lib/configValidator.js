...
var validate = (function() {
  ...
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (data.disableStartupLogging === undefined) data.disableStartupLogging = false;
          ...
          if (valid1) {
            ...
            if (valid1) {
              ...
              if (valid1) {
                ...
                var valid1 = errors === errs_1;
                if (valid1) {
                  var data1 = data.disableStartupLogging;
                  var errs_1 = errors;
                  if (typeof data1 !== "boolean") {
                    var dataType1 = typeof data1;
                    var coerced1 = undefined;
                    ...
                    if (coerced1 === undefined) {
                      validate.errors = [{
                        keyword: 'type',
                        dataPath: (dataPath || '') + '.disableStartupLogging',
                        schemaPath: '#/properties/disableStartupLogging/type',
                        params: {
                          type: 'boolean'
                        },
                        message: 'should be boolean'
                      ...
                      data1 = coerced1;
                      data['disableStartupLogging'] = coerced1;
                    }
                  }
                  var valid1 = errors === errs_1;
                  if (valid1) {
