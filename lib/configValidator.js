...
var validate = (function() {
  ...
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      ...
      if (data.exposeHeadRoutes === undefined) data.exposeHeadRoutes = true;
      var errs__0 = errors;
      var valid1 = true;
                              ...
                              if (valid1) {
                                ...
                                if (valid1) {
                                  ...
                                  if (valid1) {
                                    ...
                                    var valid1 = errors === errs_1;
                                    if (valid1) {
                                      var data1 = data.exposeHeadRoutes;
                                      var errs_1 = errors;
                                      if (typeof data1 !== "boolean") {
                                        var dataType1 = typeof data1;
                                        var coerced1 = undefined;
                                        if (coerced1 !== undefined);
                                          ...
                                          validate.errors = [{
                                            keyword: 'type',
                                            dataPath: (dataPath || '') + '.exposeHeadRoutes',
                                        ...
                                        if (coerced1 !== undefined) {
                                          data1 = coerced1;
                                          data['exposeHeadRoutes'] = coerced1;
                                        }
                                      }
                                      var valid1 = errors === errs_1;
                                      if (valid1) {}
