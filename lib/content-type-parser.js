...
function ContentTypeParser (bodyLimit, onProtoPoisoning, onConstructorPoisoning, contentTypeParserFactory) {
  this.parse = ContentType.from
  if (contentTypeParserFactory !== undefined) {
    this.parse = contentTypeParserFactory(this.parse)
    if (typeof this.parse !== 'function') {
      throw new TypeError('contentTypeParserFactory must return a function')
    }
  }
