...
function ContentTypeParser (bodyLimit, onProtoPoisoning, onConstructorPoisoning, strictContentTypeValidation = true) {
...
ContentTypeParser.prototype.getParser = function (contentType) {
  if (typeof contentType === 'string') {
    ...
    if (contentType.isValid === false && this.strictContentTypeValidation === false) {
...
function buildContentTypeParser (c) {
  ...
  contentTypeParser.strictContentTypeValidation = c.strictContentTypeValidation
