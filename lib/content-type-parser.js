...
ContentTypeParser.prototype.setParser = function (parser) {
  if (typeof parser !== 'function') {
    throw new TypeError('Content type header parser must be a function')
  }

  this.parse = headerValue => parser(headerValue, ContentType.from)
  this.cache = new Fifo(100)
}
