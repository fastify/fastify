...
function ContentTypeParser (
  ...
  this.strictContentTypeHeaderValidation = strictContentTypeHeaderValidation
}
...
ContentTypeParser.prototype.getParser = function (contentType) {
  if (typeof contentType === 'string') {
    ...
    if (contentType.isValid === false && this.strictContentTypeHeaderValidation === false) {
...
function buildContentTypeParser (c) {
  ...
  contentTypeParser.strictContentTypeHeaderValidation = c.strictContentTypeHeaderValidation
