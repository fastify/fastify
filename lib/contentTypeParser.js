...
function ContentTypeParser (bodyLimit, protoAction) {
  this[kDefaultJsonParse] = getDefaultJsonParser(protoAction)
  this.customParsers = {}
...
function getDefaultJsonParser (protoAction) {
  ...
  function defaultJsonParser (req, body, done) {
    ...
    try {
      var json = Bourne.parse(body, { protoAction })
    } catch (err) {
      err.statusCode = 400
