...
function getDefaultJsonParser (onProtoPoisoning, onConstructorPoisoning) {
  ...
  function defaultJsonParser (req, body, done) {
    ...
    let json
    try {
      json = parse(body, { protoAction: onProtoPoisoning, constructorAction: onConstructorPoisoning })
    } catch (err) {
      const fastifyError = new FST_ERR_CTP_INVALID_JSON_BODY(err.message)
      return done(fastifyError, undefined)
    }
    done(null, json)
  }
}
