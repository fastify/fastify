...
function onPredecodingHookRunner (functions, request, reply, payload, cb) {
  let i = 0
  ...
  function next (err, newPayload) {
    ...
    const result = fn(request, reply, newPayload, next)
...
function rawBody (request, reply, payload, options, parser, done) {
