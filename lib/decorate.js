...
function checkRequestExistence (name) {
  return checkExistence(this[Symbol.for('fastify.Request')].prototype, name)
}

function checkReplyExistence (name) {
  return checkExistence(this[Symbol.for('fastify.Reply')].prototype, name)
}
...
function decorateReply (name, fn, dependencies) {
  decorate(this[Symbol.for('fastify.Reply')].prototype, name, fn, dependencies)
  return this
}

function decorateRequest (name, fn, dependencies) {
  decorate(this[Symbol.for('fastify.Request')].prototype, name, fn, dependencies)
  return this
}
