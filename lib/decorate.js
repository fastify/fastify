...
function checkRequestExistence (name) {
  return checkExistence(this[symbols.RequestKey].prototype, name)
}

function checkReplyExistence (name) {
  return checkExistence(this[symbols.ReplyKey].prototype, name)
}
...
function decorateReply (name, fn, dependencies) {
  decorate(this[symbols.ReplyKey].prototype, name, fn, dependencies)
  return this
}

function decorateRequest (name, fn, dependencies) {
  decorate(this[symbols.RequestKey].prototype, name, fn, dependencies)
  return this
}
