...
function fallbackErrorHandler (error, reply, cb) {
  ...
  let payload
  try {
    let serializerFn = getSchemaSerializer(reply[kRouteContext], statusCode, reply[kReplyHeaders]['content-type'])
    serializerFn = typeof serializerFn === 'object' ? Object.values(serializerFn)[0] : serializerFn
