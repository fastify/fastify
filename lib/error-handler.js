  ...
  if (reply[kReplyNextErrorHandler] === false) {
    fallbackErrorHandler(error, reply, function (reply, payload) {
      try {
        ...
        reply.server.logDispatcher.writeHeadError(error, reply)
...
function defaultErrorHandler (error, request, reply) {
  ...
  reply.server.logDispatcher.defaultErrorLog(error, request, reply)
  reply.send(error)
}
...
function fallbackErrorHandler (error, reply, cb) {
  ...
  try {
    ...
    reply.server.logDispatcher.serializerError(err, reply, res.statusCode)
