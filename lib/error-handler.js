  ...
  if (reply[kReplyNextErrorHandler] === false) {
    fallbackErrorHandler(error, reply, function (reply, payload) {
      try {
        ...
        reply.server[kLogDispatcher].writeHeadError(error, reply)
...
function defaultErrorHandler (error, request, reply) {
  ...
  request.server[kLogDispatcher].defaultErrorLog(error, request, reply)
  reply.send(error)
}
...
function fallbackErrorHandler (error, reply, cb) {
  ...
  try {
    ...
    reply.server[kLogDispatcher].serializerError(err, reply, res.statusCode)
