  ...
  if (reply[kReplyNextErrorHandler] === false) {
    fallbackErrorHandler(error, reply, function (reply, payload) {
      try {
        ...
        reply.server.internalLogger.writeHeadError(error, reply)
...
function defaultErrorHandler (error, request, reply) {
  ...
  reply.server.internalLogger.defaultErrorLog(error, request, reply)
  reply.send(error)
}
...
function fallbackErrorHandler (error, reply, cb) {
  ...
  try {
    ...
    reply.server.internalLogger.serializerError(err, reply, res.statusCode)
