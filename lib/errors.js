...
const codes = {
  ...
  */
  FST_ERR_CTS_ALREADY_PRESENT: createError(
    'FST_ERR_CTS_ALREADY_PRESENT',
    "Content type serializer '%s' already present."
  ),
  FST_ERR_CTS_INVALID_TYPE: createError(
    'FST_ERR_CTS_INVALID_TYPE',
    'The content type should be a valid media type',
    500,
    TypeError
  ),
  FST_ERR_CTS_INVALID_HANDLER: createError(
    'FST_ERR_CTS_INVALID_HANDLER',
    'The content type serializer should be a function',
    500,
    TypeError
  ),
