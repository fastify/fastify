...
const codes = {
  ...
  */
  ...
  /**
   * http.maxRequestsPerSocket
   */
  FST_ERR_HTTP_MAX_REQUESTS_PER_SOCKET_INVALID_VERSION: createError(
    'FST_ERR_HTTP_MAX_REQUESTS_PER_SOCKET_INVALID_VERSION',
    '"maxRequestsPerSocket" is available only from node >= 16.10.0'
  ),
