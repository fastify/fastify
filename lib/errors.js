...
const codes = {
  ...
  */
  ...
  FST_ERR_ERROR_CAUSE_ALREADY_PRESENT: createError(
    'FST_ERR_ERROR_CAUSE_ALREADY_PRESENT',
    'An error handler threw an error with the `cause` property set, so Fastify will not set the cause to the original error.'
  ),
