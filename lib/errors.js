...
createError('FST_ERR_CTP_EMPTY_TYPE', TypeError)
createError('FST_ERR_CTP_INVALID_HANDLER', TypeError)
createError('FST_ERR_CTP_INVALID_PARSE_TYPE', TypeError)
createError('FST_ERR_CTP_BODY_TOO_LARGE', RangeError)
createError('FST_ERR_CTP_INVALID_MEDIA_TYPE')
createError('FST_ERR_CTP_INVALID_CONTENT_LENGTH', RangeError)
