...
const codes = {
  ...
  */
  ...
  FST_ERR_LOG_INVALID_LOG_DISPATCHER: createError(
    'FST_ERR_LOG_INVALID_LOG_DISPATCHER',
    "logDispatcher option must be an object. Invalid keys: '%s'.",
    500,
    TypeError
  ),

  FST_ERR_LOG_INVALID_LOG_DISPATCHER_FN: createError(
    'FST_ERR_LOG_INVALID_LOG_DISPATCHER_FN',
    'logDispatcher.%s must be a function.',
    500,
    TypeError
  ),
