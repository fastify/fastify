...
const codes = {
  ...
  */
  ...
  FST_ERR_SCH_CONTENT_INVALID_CONTENT_TYPE: createError(
    'FST_ERR_SCH_CONTENT_INVALID_CONTENT_TYPE',
    "Invalid content type '%s' in schema.content"
  ),
  FST_ERR_SCH_CONTENT_DUPLICATE: createError(
    'FST_ERR_SCH_CONTENT_DUPLICATE',
    "Duplicate case-equivalent content schema for '%s'"
  ),
