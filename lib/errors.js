...
const codes = {
  ...
  */
  ...
  FST_ERR_LOG_INVALID_LOGGER_CONFIG_AND_LOGGER_INSTANCE: createError(
    'FST_ERR_LOG_INVALID_LOGGER_CONFIG_AND_LOGGER_INSTANCE',
    'You cannot provide both logger and loggerInstance. Please provide any one.',
    500,
    TypeError
  ),
