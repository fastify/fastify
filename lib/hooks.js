...
Hooks.prototype.validateAsyncHookParams = function (hook, fn) {
  ...
  switch (hook) {
    case 'onReady':
      shouldThrow = fn.length !== 0
      break
    case 'onRoute':
      shouldThrow = fn.length !== 1
      break
    case 'onClose':
    case 'onRegister':
      shouldThrow = fn.length === 2
      break
    case 'onTimeout':
    case 'onRequest':
    case 'preHandler':
    case 'onResponse':
      shouldThrow = fn.length === 3
      break
    case 'onSend':
    case 'onError':
