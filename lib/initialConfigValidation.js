...
function validateInitialConfig (options) {
  ...
  const isMaxRequestsPerSocketNull = options.maxRequestsPerSocket === null
  ...
  // `null` is a valid option for `maxRequestsPerSocket`
  // it should not be coerced by `ajv`
  if (isMaxRequestsPerSocketNull) {
    opts.maxRequestsPerSocket = null
  }
