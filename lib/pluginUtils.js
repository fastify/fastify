...
function checkDecorators (fn) {
  ...
  if (decorators.reply) _checkDecorators.call(this[symbols.ReplyKey], 'Reply', decorators.reply)
  if (decorators.request) _checkDecorators.call(this[symbols.RequestKey], 'Request', decorators.request)
}
