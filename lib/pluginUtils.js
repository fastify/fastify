...
function checkDecorators (fn) {
  ...
  if (decorators.reply) _checkDecorators.call(this[Symbol.for('fastify.Reply')], 'Reply', decorators.reply)
  if (decorators.request) _checkDecorators.call(this[Symbol.for('fastify.Request')], 'Request', decorators.request)
}
