...
function checkDecorators (fn) {
  ...
  if (decorators.reply) _checkDecorators.call(this[ReplyKey], 'Reply', decorators.reply)
  if (decorators.request) _checkDecorators.call(this[RequestKey], 'Request', decorators.request)
}
