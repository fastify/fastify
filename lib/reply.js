...
Reply.prototype.send = function (payload) {
  ...
  if (this.sent === true) {
    // The payload is dropped here. If it is a thenable, nothing would ever
    // observe its outcome, so an eventual rejection would surface as an
    // unhandled rejection and terminate the process by default. Attach a
    // handler that reports it instead.
