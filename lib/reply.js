...
Reply.prototype.compileSerializationSchema = function (schema, httpStatus) {
  ...
  if (this.context[kRequestSerializeFns].has(schema)) {
    return this.context[kRequestSerializeFns].get(schema)
  }
  ...
  if (serializerCompiler != null) {
    ...
    serialize = this.server[kSchemaController]
      .serializerCompiler({
        schema,
        method,
        url,
  ...
  // TODO: change symbol name once the API is agreed on
