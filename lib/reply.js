...
function Reply (res, context, request, log) {
  ...
  this[kReplyDisableStringify] = false
  this.log = log
}
...
Reply.prototype.disableStringify = function (flag) {
  this[kReplyDisableStringify] = flag
  this.context[kReplyDisableStringify] = flag
  return this
}
