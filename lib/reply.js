...
Reply.prototype.compileSerializationSchema = function (schema, httpStatus = null, contentType = null) {
  ...
  const cachedFns = this[kRouteContext][kReplyCacheSerializeFns]?.get(schema)
  ...
  if (cachedFns == null) {
    this[kRouteContext][kReplyCacheSerializeFns].set(schema, new Map([[cacheKey, serializeFn]]))
  } else {
