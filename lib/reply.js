...
Reply.prototype.send = function (payload) {
  ...
  if (hasContentType && this[kReplySerializer] === null) {
    const serializers = this[kRouteContext].server[kContentTypeSerializer]
    this[kReplySerializer] = serializers[contentType.toString()] || serializers[contentType.mediaType] || null
  }
