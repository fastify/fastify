...
const { FST_ERR_REQ_INVALID_VALIDATION_INVOCATION, FST_ERR_DEC_UNDECLARED, FST_ERR_MISSING_HANDLER_TIMEOUT } = require('./errors')
...
Object.defineProperties(Request.prototype, {
  ...
  signal: {
    get () {
      const ac = this[kRequestSignal]
      if (ac) return ac.signal
      throw new FST_ERR_MISSING_HANDLER_TIMEOUT()
    }
  },
  ip: {
    get () {
