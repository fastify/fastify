...
Object.defineProperties(Request.prototype, {
  ...
  getValidationFunction: {
    value: function (httpPartOrSchema) {
      if (typeof httpPartOrSchema === 'string') {
        ...
        return this[kContext][symbol]
      } else if (typeof httpPartOrSchema === 'object') {
        return this[kContext][kRequestValidateWeakMap]?.get(httpPartOrSchema)
      }
    }
  },
  compileValidationSchema: {
    value: function (schema, httpPart = null) {
      ...
      if (this[kContext][kRequestValidateWeakMap]?.has(schema)) {
        return this[kContext][kRequestValidateWeakMap].get(schema)
      }

      const validatorCompiler = this[kContext].validatorCompiler ||
     ...
     (
      ...
      if (this[kContext][kRequestValidateWeakMap] == null) {
        this[kContext][kRequestValidateWeakMap] = new WeakMap()
      }

      this[kContext][kRequestValidateWeakMap].set(schema, validateFn)
  ...
  validateInput: {
    value: function (input, schema, httpPart) {
      ...
      if (validate == null) {
        if (this[kContext][kRequestValidateWeakMap]?.has(schema)) {
          validate = this[kContext][kRequestValidateWeakMap].get(schema)
        } else {
