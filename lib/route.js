      ...
      this.after((notHandledErr, done) => {
        ...
        avvio.once('preReady', () => {
          ...
          if (opts.validatorCompiler) {
            context.routeOptions.validatorCompiler = opts.validatorCompiler
          }

          if (opts.serializerCompiler) {
            context.routeOptions.serializerCompiler = opts.serializerCompiler
          }
          ...
          if (opts.schema) {
            ...
            try {
              ...
              context.routeOptions.validatorCompiler = opts.validatorCompiler || schemaController.validatorCompiler
            } catch (error) {
            ...
            try {
              ...
              context.routeOptions.serializerCompiler = opts.serializerCompiler || schemaController.serializerCompiler || null
            } catch (error) {
