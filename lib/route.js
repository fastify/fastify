...
function normalizeAndValidateMethod (method) {
  ...
  if (!this[kAcceptedHTTPMethods].bodyless.has(method) &&
    !this[kAcceptedHTTPMethods].bodywith.has(method)) {
...
function validateSchemaBodyOption (method, path, schema) {
  if (this[kAcceptedHTTPMethods].bodyless.has(method) && schema?.body) {
