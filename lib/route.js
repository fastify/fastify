...
function buildRouting (options) {
  ...
  let customAttributeKeysObj = null
  ...
  return {
    ...
    setup (options, fastifyArgs) {
      if (options?.loggerCustomAttributeKeys) {
        ...
        if (reqKey !== 'req' || resKey !== 'res' || errKey !== 'err') {
          customAttributeKeysObj = { reqKey, resKey, errKey }
        }
      }
  ...
  function routeHandler (req, res, params, context, query) {
    ...
    if (customAttributeKeysObj !== null) {
      childLogger[kCustomAttributeKeys] = customAttributeKeysObj
    }
