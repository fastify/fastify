...
function buildRouterOptions (options, defaultOptions) {
  ...
  if (Object.hasOwn(options, 'ignoreTrailingSlash') || Object.hasOwn(options, 'ignoreDuplicateSlashes') || Object.hasOwn(options, 'maxParamLength') || Object.hasOwn(options, 'caseSensitive') || Object.hasOwn(options, 'allowUnsafeRegex') || Object.hasOwn(options, 'querystringParser') || Object.hasOwn(options, 'useSemicolonDelimiter') || Object.hasOwn(options, 'constraints')) {
    FSTDEP022()
  }
