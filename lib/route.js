...
function buildRouting (options) {
  ...
  function route (options) {
    ...
    /**
     * This function sets up a new route, it's log serializers, triggers route hooks
     *
     * @param {object} opts contains route `path` and `prefixing` flag which indicates if this is an auto-prefixed route
     * @param {*} notHandledErr error object
     * @param {*} done callback
     */
