...
function buildRouting (options) {
  ...
  function route (opts) {
    ...
    function afterRouteAdded (path, notHandledErr, done) {
      ...
      if (opts.schema) {
        if (!opts.schemaCompiler && !this[kValidatorCompiler]) {
        ...
        // TODO
        // if (!this[kSerializerCompiler]) {
        //   // if the instance doesn't have a serializer, build the default one for the single fastify instance
        //   this.setSerializerCompiler(buildSchemaCompiler(externalSchemas, this[kOptions].ajv, schemaCache))
        // }
