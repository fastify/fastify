...
function buildRouting (options) {
  ...
  function setup (options, fastifyArgs) {
    ...
    function afterRouteAdded (path, notHandledErr, done) {
      ...
      avvio.once('preReady', () => {
        ...
        if (opts.schema) {
          ...
          const schemaController = this[kSchemas]
          if (!opts.validatorCompiler && !schemaController.hasReadyValidator()) {
            // if the instance doesn't have a validator, build the default one for the single fastify instance
            schemaController.setupValidator(this[kOptions].ajv)
          }
          try {
          ...
          if (opts.schema.response &&
            ...
            !schemaController.hasReadySerializer()) {
