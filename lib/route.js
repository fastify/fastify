...
const { onRunMiddlewares } = require('./middleware')
...
module.exports = function buildRouting (options) {
  ...
  return {
    fill (args) {
      ...
      querystringParser = args.querystringParser
      requestIdLogLabel = args.requestIdLogLabel
      logger = args.logger
      hasLogger = args.hasLogger
      setupResponseListeners = args.setupResponseListeners
      proxyFn = args.proxyFn
      modifyCoreObjects = args.modifyCoreObjects
      genReqId = args.genReqId
    },
