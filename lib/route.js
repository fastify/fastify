...
function buildRouting (options) {
  ...
  const buildPerformanceValidator = ValidatorSelector()
  ...
  function route (opts) {
    ...
    function afterRouteAdded (path, notHandledErr, done) {
      ...
      if (opts.schema) {
        ...
        console.log('route ---', this[kValidatorCompiler])
        ...
        if (!opts.validatorCompiler && !this[kValidatorCompiler]) {
          ...
          this.setValidatorCompiler(buildPerformanceValidator(sBucket.getSchemas(), this[kOptions].ajv, sBucket.cache))
        }
        try {
