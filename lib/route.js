...
const {
  ...
  FST_ERR_HOOK_INVALID_REGISTRATION
} = require('./errors')
          ...
          if (Array.isArray(opts[hook])) {
            for (const func of opts[hook]) {
              if (typeof func !== 'function') {
                throw new FST_ERR_HOOK_INVALID_REGISTRATION(hook, typeof func)
              }
            }
          } else if (typeof opts[hook] !== 'function') {
            throw new FST_ERR_HOOK_INVALID_REGISTRATION(hook, typeof opts[hook])
          }
        }
      }
