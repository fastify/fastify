...
function buildRouting (options) {
  ...
  function route (opts) {
    ...
    function afterRouteAdded (path, notHandledErr, done) {
      ...
      opts.logSerializer = opts.logSerializer || this[kLogSerializer]
  ...
  function routeHandler (req, res, params, context) {
    ...
    var serializers = context.logSerializer || {}
    var childLogger = logger.child({ [requestIdLogLabel]: req.id, level: context.logLevel, serializers })
