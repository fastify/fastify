      ...
      this.after((notHandledErr, done) => {
        ...
        avvio.once('preReady', () => {
          ...
          if (opts.validatorCompiler) {
            context.config.validatorCompiler = opts.validatorCompiler
          }

          if (opts.serializerCompiler) {
            context.config.serializerCompiler = opts.serializerCompiler
          }
          ...
          if (opts.schema) {
            ...
            try {
              ...
              context.config.validatorCompiler = opts.validatorCompiler || schemaController.validatorCompiler || null
            } catch (error) {
            ...
            try {
              ...
              context.config.serializerCompiler = opts.serializerCompiler || schemaController.serializerCompiler || null
            } catch (error) {
