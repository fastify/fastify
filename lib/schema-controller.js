...
class SchemaController {
  ...
  setupValidator (serverOption) {
    ...
    this.validatorCompiler = this.compilersFactory.buildValidator(this.schemaBucket.getSchemas('valid'), serverOption.ajv)
  }
  ...
  setupSerializer (serverOption) {
    ...
    this.serializerCompiler = this.compilersFactory.buildSerializer(this.schemaBucket.getSchemas('ser'))
  }
}
