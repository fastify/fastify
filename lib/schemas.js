...
Schemas.prototype.resolveRefs = function (routeSchemas, dontClearId) {
  ...
  for (const key of ['headers', 'querystring', 'query', 'params', 'body']) {
  ...
  const querystring = routeSchemas.querystring || routeSchemas.query
  if (querystring) {
    routeSchemas.querystring = this.getSchemaAnyway(querystring)
  }
