...
function normalizeSchema (routeSchemas, serverOptions) {
  ...
  if (routeSchemas.response) {
    ...
    for (const code of httpCodes) {
      if (routeSchemas.response[code].content && !routeSchemas.response[code].content.type) {
        for (const mediaName in routeSchemas.response[code].content) {
          routeSchemas.response[code].content[mediaName].schema = getSchemaAnyway(routeSchemas.response[code].content[mediaName].schema, serverOptions.jsonShorthand)
        }
      } else {
