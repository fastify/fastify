...
const { kSchemaVisited, kSchemaResponse, kSchemaFromStore } = require('./symbols')
...
Schemas.prototype.add = function (inputSchema) {
  if (inputSchema[kSchemaFromStore]) {
    return
  }
...
Schemas.prototype.getSchema = function (schemaId) {
  const schema = this.store[schemaId]
  if (schema) {
    schema[kSchemaFromStore] = true
  }
  return schema
}
