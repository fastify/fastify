...
const { jsonDraft7Keys } = require('./schemasUtils')
...
function checkIfDraft7SubSet (schema) {
  return Object.keys(schema).every(val => jsonDraft7Keys.includes(val))
}
