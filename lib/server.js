...
/**
 * Creates a function, based upon initial configuration, that will
 * be used to verify every incoming request conforms to allowed
 ...
 * @param {boolean} [options.http2 = false] <need a description>
 *
 * @returns {function} HTTP version validator function.
 */
function compileValidateHTTPVersion (options) {
  let bypass = false
  // key-value object to store valid http version
  const obj = {}
