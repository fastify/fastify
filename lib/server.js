        ...
        return listening.then(address => {
          return new Promise((resolve, reject) => {
            multipleBindings.call(this, server, httpHandler, options, listenOptions, () => {
              ...
              // this.onListen()
              // hookRunnerApplication('onListen', this.onListen, this, function () {
              //   console.log('Interesting error function...')
              // })
              hookRunnerApplication('onListen', this[kAvvioBoot], this, function () {
                // console.log('Interesting error function...')
              })
              // for (const hook of this[kHooks].onListen) {
              //   hook.call(this)
