    ...
    if (cb === undefined) {
      ...
      return listening.then(address => {
        return new Promise((resolve, reject) => {
          function handleOnListenError (err) {
            if (err) {
              reject(err)
            }
          }
          if (host === 'localhost') {
            multipleBindings.call(this, server, httpHandler, options, listenOptions, () => {
              this[kState].listening = true
              this[kAvvioBoot](() => {})
              hookRunnerApplication('onListen', this[kAvvioBoot], this, handleOnListenError)
              resolve(address)
            })
          } else {
            hookRunnerApplication('onListen', this[kAvvioBoot], this, handleOnListenError)
...
function listenPromise (server, listenOptions) {
  ...
  return this.ready().then(() => {
    ...
    console.log('server.listen call')
    ...
    // console.log('Calling onListen hookRunner')
    // this[kAvvioBoot](() => {})
