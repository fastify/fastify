...
function createServer (options, httpHandler) {
  ...
  function listen (listenOptions, ...args) {
    ...
    const serverFactoryListening = (options.serverFactory && options.serverFactory.listening) || (options.serverFactory === server)
    if (host === 'localhost' && !serverFactoryListening) {
    ...
    if (cb === undefined && !serverFactoryListening) {
