...
const {
  ValidatorCompiler: buildDefaultValidatorCompiler,
  SerializerCompiler: buildDefaultSerializerCompiler
...
function buildSchemaValidatorCompiler (schemas, options) {
  return buildDefaultValidatorCompiler(Object.values(schemas.getSchemas()), options, schemas.cache)
}

function buildSchemaSerializerCompiler (schemas) {
  return buildDefaultSerializerCompiler(schemas.getSchemas())
}
