  ...
  context[responseSchema] = Object.keys(context.schema.response)
    .reduce(function (acc, statusCode) {
      ...
      if (Array.isArray(schema.contentTypes)) {
        ...
        for (const contentTypeResponse of schema.contentTypes) {
          const contentSchema = contentTypeResponse.schema
          contentTypesSchemas[contentTypeResponse.content] = compile({
