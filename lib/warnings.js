 ...
 *                             - FSTDEP022 - FSTDEP024 are used by v5 and MUST NOT be reused.
...
const FSTDEP023 = createWarning({
  ...
  code: 'FSTDEP023',
  message: 'disableRequestLogging option is deprecated. Use the logDispatcher option with disableRequestLogging or isLogDisabled override instead. The disableRequestLogging top-level option will be removed in `fastify@6`.',
  unlimited: true
})
...
const FSTDEP024 = createWarning({
  name: 'FastifyDeprecation',
  code: 'FSTDEP024',
  message: 'requestIdLogLabel option is deprecated. Use the logDispatcher option with requestIdLogLabel instead. The requestIdLogLabel top-level option will be removed in `fastify@6`.',
  unlimited: true
})
