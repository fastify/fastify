...
const FSTDEP022 = function (deprecationOptions) {
  return createWarning({
    name: 'FastifyWarning',
    code: 'FSTDPE022',
    message: `The following router options for ${deprecationOptions} property access is deprecated. Please use "options.routerOptions" instead for accessing router options. The "options.ignoreTrailingSlash" will be removed in \`fastify@6\`.`,
    unlimited: true
  })
}
