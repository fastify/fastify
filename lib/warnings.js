...
const FSTSEC001 = createWarning({
  ...
  code: 'FSTSEC001',
  message: 'You are using /%s/ Content-Type which may be vulnerable to CORS attacks. Please make sure your RegExp starts with "^" or includes ";?" to properly detect the essential MIME type.',
  unlimited: true
})
