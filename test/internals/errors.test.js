...
test('FST_ERR_LOG_INVALID_LOGGER_CONFIG_AND_LOGGER_INSTANCE', t => {
  t.plan(5)
  const error = new errors.FST_ERR_LOG_INVALID_LOGGER_CONFIG_AND_LOGGER_INSTANCE()
  t.equal(error.name, 'FastifyError')
  t.equal(error.code, 'FST_ERR_LOG_INVALID_LOGGER_CONFIG_AND_LOGGER_INSTANCE')
