...
import { DoneFuncWithErrOrRes, HookHandlerDoneFunction } from '../../types/hooks'
import { ContentTypeParserDoneFunction } from '../../types/content-type-parser'
...
expectType<void>(fastify().addContentTypeParser('contentType', function (req: IncomingMessage, done: ContentTypeParserDoneFunction) {
