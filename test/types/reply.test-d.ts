...
const getHandler: RouteHandlerMethod = function (_request, reply) {
  ...
  expectType<(key: string, fn: (() => string) | ((reply: FastifyReply, payload: string | Buffer | null) => Promise<string>) | ((reply: FastifyReply, payload: string | Buffer | null, done: (err: Error | null, value?: string) => void) => void)) => FastifyReply>(reply.trailer)
