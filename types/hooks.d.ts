 ...
 * It is the sixth hook to be executed in the request lifecycle. The previous hook was `preSerialization`,
 ...
 * The onResponse hook is executed when a response has been sent, so you will not be able to
 * send more data to the client. It can however be useful for sending data to external services,
 ...
 * This hook will be executed only after the customErrorHandler has been executed, and
 * only if the customErrorHandler sends an error back to the user
