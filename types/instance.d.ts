...
export interface FastifyInstance<Generic extends FastifyInstanceGenericInterface = FastifyInstanceHttpsGenericInterface> {
  ...
  // >(opts: RouteOptions<RawServer, RawRequest, RawReply, RouteGeneric, ContextConfig, SchemaCompiler, TypeProvider>): this;
  ...
  //   handler: (this: this, error: TError, request: FastifyRequest<RouteGeneric, RawServer, RawRequest, SchemaCompiler, TypeProvider>, reply: FastifyReply<RawServer, RawRequest, RawReply, RouteGeneric, ContextConfigDefault, SchemaCompiler, TypeProvider>) => any | Promise<any>
  // ): this;
