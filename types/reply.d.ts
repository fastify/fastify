...
> {
  ...
  redirect: ((statusCode: number, url: string) => FastifyReply<RawServer, RawRequest, RawReply, RouteGeneric, ContextConfig>) & ((url: string) => FastifyReply<RawServer, RawRequest, RawReply, RouteGeneric, ContextConfig>)
  callNotFound: () => void
