...
export type CallTypeProvider<F extends AnyFastifyTypeProvider, I, T extends keyof FastifySeperatedTypeProvider>
  = F extends FastifySeperatedTypeProvider ? (F[T] & { schema: I })
...
type ResolveRequestParams<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema, RouteGeneric extends RouteGenericInterface> =
  UndefinedToUnknown<KeysOf<RouteGeneric['Params']> extends never ? CallTypeProvider<TypeProvider, SchemaCompiler['params'], 'validator'> : RouteGeneric['Params']>
type ResolveRequestQuerystring<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema, RouteGeneric extends RouteGenericInterface> =
  UndefinedToUnknown<KeysOf<RouteGeneric['Querystring']> extends never ? CallTypeProvider<TypeProvider, SchemaCompiler['querystring'], 'validator'> : RouteGeneric['Querystring']>
type ResolveRequestHeaders<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema, RouteGeneric extends RouteGenericInterface> =
  UndefinedToUnknown<KeysOf<RouteGeneric['Headers']> extends never ? CallTypeProvider<TypeProvider, SchemaCompiler['headers'], 'validator'> : RouteGeneric['Headers']>
type ResolveRequestBody<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema, RouteGeneric extends RouteGenericInterface> =
  UndefinedToUnknown<KeysOf<RouteGeneric['Body']> extends never ? CallTypeProvider<TypeProvider, SchemaCompiler['body'], 'validator'> : RouteGeneric['Body']>
...
export interface ResolveFastifyRequestType<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema, RouteGeneric extends RouteGenericInterface> extends FastifyRequestType {
...
type ResolveReplyFromSchemaCompiler<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema> = {
  [K1 in keyof SchemaCompiler['response']]: SchemaCompiler['response'][K1] extends { content: { [keyof: string]: { schema: unknown } } } ? ({
    [K2 in keyof SchemaCompiler['response'][K1]['content']]: CallTypeProvider<TypeProvider, SchemaCompiler['response'][K1]['content'][K2]['schema'], 'serializer'>
  } extends infer Result ? Result[keyof Result] : unknown) : CallTypeProvider<TypeProvider, SchemaCompiler['response'][K1], 'serializer'>
...
export type ResolveFastifyReplyType<TypeProvider extends AnyFastifyTypeProvider, SchemaCompiler extends FastifySchema, RouteGeneric extends RouteGenericInterface> = UndefinedToUnknown<KeysOf<RouteGeneric['Reply']> extends never ? ResolveReplyFromSchemaCompiler<TypeProvider, SchemaCompiler> : RouteGeneric['Reply']>
...
export type ResolveFastifyReplyReturnType<
  TypeProvider extends AnyFastifyTypeProvider,
